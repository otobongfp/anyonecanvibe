...
export default function BucketPanel({
  ...
  return (
    <>
      ...
      <button
        onClick={onToggle}
        className={`fixed top-6 right-4 z-50 wire-button p-2 flex items-center space-x-2 transition-all duration-200 ${
      ...
      {isOpen && (
        <>
          ...
          />
          {/* Panel */}
          <div className="fixed top-0 right-0 h-full w-full sm:w-96 bg-wire-bg border-l-2 border-wire-stroke z-50 animate-slide-in">
